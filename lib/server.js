...
(function() {
    var LogNode, LogServer, LogStream, WebServer, events, express, fs, http, https, io, net, winston, _LogObject, mongoose, Node,
    ...
    */
    ...
    LogServer = (function(_super) {
        ...
        function LogServer(config) {
            ...
            mongoose.connect('mongodb://localhost/logio');
        ...
        LogServer.prototype._addNode = function(nname, snames) {
            ...
            // add node to mongo
            var n = new Node();
            n.saveNew(nname, snames, function(err, doc) {
                return _this.__add(nname, snames, _this.logNodes, LogNode, 'node');                
            });
        };
